...
import com.example.trading_system_backend.service.IOrderService;
...
import static com.example.trading_system_backend.bean.res.CounterRes.SUCCESS;
...
//    }
    ...
    public CounterRes posiQuery(@RequestParam long uid)
            throws Exception {
        List<PositionInfo> postList = orderService.getPostList(uid);
